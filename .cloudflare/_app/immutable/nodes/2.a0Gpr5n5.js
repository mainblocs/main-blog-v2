import{a as x,t as f,e as n,c as a,s as l,l as M,o as W}from"../chunks/disclose-version.Bs4Y-PDV.js";import{a as v,p,r as B}from"../chunks/runtime.BCQlBliF.js";import{i as m}from"../chunks/lifecycle.BeInBq4H.js";import{t as _}from"../chunks/class.CWwZdcnh.js";import{p as L}from"../chunks/proxy.D9fXiWc6.js";import{O as P,L as A}from"../chunks/open.BPByRcNo.js";var $=f(`<div class="mx-auto max-w-5xl px-6 lg:px-12 mt-24 sm:mt-32 lg:mt-40 mb-24" data-aos="fade-in"><div class="md:rounded-4xl bg-neutral-950 px-6 py-20 sm:mx-0 sm:py-32 md:px-16 rounded-3xl" style="opacity: 1; transform: none;"><div class="mx-auto max-w-4xl"><div class="max-w-xl"><h2 class="font-yoga text-3xl font-medium text-white [text-wrap:balance] sm:text-4xl">Tell us about your project</h2> <div class="mt-12 flex"><a class="inline-flex rounded-full px-4 py-1.5 text-sm font-semibold transition bg-white
						text-neutral-950 hover:bg-neutral-200" href="/contact"><span class="relative py-2 px-8">Say Hi</span></a></div> <div class="mt-10 border-t border-white/10 pt-10"><h3 class="font-display text-base font-semibold text-white">Our offices</h3> <ul role="list" class="mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2"><li><address class="text-sm not-italic text-neutral-300"><strong class="text-white">Los Angeles</strong> <br> Santa Monica Blvd <br> California, USA</address></li></ul></div></div></div></div></div>`);function S(s,t){v(t,!1),m();var e=$();x(s,e),p()}var O=f(`<section class="bg-grey py-16"><div class="wrapper px-2"><h2 class="text-4xl font-bold pb-24 font-yoga lg:text-5xl">Our Clients</h2> <div class="flex flex-wrap gap-12 clientContainer justify-center items-center mx-auto"><div class="flex flex-col justify-center items-center w-full sm:w-2/3 h-[150px] md:h-auto
				md:w-[275px]"><img src="/phases.png" alt="Phases"></div> <div class="flex flex-col justify-center items-center w-full sm:w-2/3 h-[150px] md:h-auto
				md:w-[275px]"><img src="/chapter.png" alt="Phases"></div> <div class="flex flex-col justify-center items-center w-full sm:w-2/3 h-[150px] md:h-auto
				md:w-[275px]"><img src="/crowd.png" alt="Phases"></div> <div class="flex flex-col justify-center items-center w-full sm:w-2/3 h-[150px] md:h-auto
				md:w-[275px]"><img src="/curaaid.png" alt="Phases"></div> <div class="flex flex-col justify-center items-center w-full sm:w-2/3 h-[150px] md:h-auto
				md:w-[275px]"><img src="/memento.png" alt="Phases"></div> <div class="flex flex-col justify-center items-center w-full sm:w-2/3 h-[150px] md:h-auto
				md:w-[275px]"><img src="/schematiq.png" alt="Phases"></div> <div class="flex flex-col justify-center items-center w-full sm:w-2/3 h-[150px] md:h-auto
				md:w-[275px]"><img src="/spring.png" alt="Phases"></div> <div class="flex flex-col justify-center items-center w-full sm:w-2/3 h-[150px] md:h-auto
				md:w-[275px]"><img src="/wilderness.png" alt="Phases"></div></div></div></section>`);function D(s,t){v(t,!1),m();var e=O();x(s,e),p()}var H=f('<div class="flex flex-col justify-center items-center md:flex-row flex-wrap gap-6 mt-24"><div class="image-container z-[100] w-[22%] h-[300px] min-w-[300px] max-h-[300px] svelte-16x40xd"><img class="w-full h-full object-cover rounded-lg  svelte-16x40xd" src="/head.webp" alt="Lamp on White Background" loading="lazy"> <div class="hover-image flex flex-col gap-4 svelte-16x40xd"><img alt="Lamp on White Background" class="w-full h-full object-cover rounded-lg  svelte-16x40xd" src="/chicago.webp" loading="lazy"> <div class="w-full bg-gray-200 absolute bottom-0 right-0 p-4"><a href="#" class=" text-black w-full bg-gray-200 flex gap-3 items-center"><span class="text-nowrap">View Casestudy</span> <!></a></div></div></div> <div class="image-container z-[100] w-[22%] h-[300px] min-w-[300px] max-h-[300px] svelte-16x40xd"><img alt="Lamp on White Background" class="w-full h-full object-cover rounded-lg svelte-16x40xd" src="/chicago.webp" loading="lazy"> <img class="w-full h-full object-cover rounded-lg hover-image svelte-16x40xd" src="/head.webp" alt="Lamp on White Background" loading="lazy"></div> <div class="image-container z-[100] w-[22%] h-[300px] min-w-[300px] max-h-[300px] svelte-16x40xd"><img src="/indie.webp" class="w-full h-full object-cover rounded-lg svelte-16x40xd" alt="Macbook Mockup on White Table" loading="lazy"> <img class="w-full h-full object-cover rounded-lg hover-image svelte-16x40xd" src="/head.webp" alt="Lamp on White Background" loading="lazy"></div> <div class="image-container z-[100] w-[22%] h-[300px] min-w-[300px] max-h-[300px] svelte-16x40xd"><img alt="Lamp on White Background" class="w-full h-full object-cover rounded-lg svelte-16x40xd" src="/superstore.webp" loading="lazy"> <img class="w-full h-full object-cover rounded-lg hover-image svelte-16x40xd" src="/head.webp" alt="Lamp on White Background" loading="lazy"></div></div>');function V(s,t){v(t,!0);let e=L({index:0,hovering:!1});function c(d){console.log("hovering",e),e.hovering=!0,e.index=d}function i(d){e.hovering=!1,e.index=d}var o=H(),r=a(o),u=a(r),g=l(l(u,!0)),w=a(g),h=l(l(w,!0)),k=a(h),C=a(k),j=l(l(C,!0));P(j,{});var b=l(l(r,!0)),y=l(l(b,!0)),z=l(l(y,!0));B(()=>{_(r,"opacity-50",e.hovering==!0&&e.index!=1),_(b,"opacity-50",e.hovering==!0&&e.index!=2),_(y,"opacity-50",e.hovering==!0&&e.index!=3),_(z,"opacity-50",e.hovering==!0&&e.index!=4)}),n("mouseenter",r,d=>c(1),!1),n("mouseleave",r,d=>i(1),!1),n("mouseenter",b,d=>c(2),!1),n("mouseleave",b,d=>i(2),!1),n("mouseenter",y,d=>c(3),!1),n("mouseleave",y,d=>i(3),!1),n("mouseenter",z,d=>c(4),!1),n("mouseleave",z,d=>i(4),!1),x(s,o),p()}var q=M(`<svg class="rotate-90 w-full h-full font-bold" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffffff" height="474.1" preserveAspectRatio="xMidYMid meet" version="1" viewBox="0.0 0.0 143.9 474.1" width="143.9" zoomAndPan="magnify"><g id="change1_1"><path d="M143.9004,66.6838v8.2128c-14.3914,0-47.0732-5.4281-67.8438-50.7603v449.9972h-8.2128V24.1356
			C47.0717,69.4685,14.3899,74.8966,0,74.8966v-8.2128c14.5849,0,50.4076-6.4974,68.0082-66.6838h7.884
			C93.4907,60.1864,129.3154,66.6838,143.9004,66.6838z"></path></g></svg>`);function E(s,t){v(t,!1),m();var e=q();x(s,e),p()}var I=f(`<section class="bg-bgprimary text-white hero py-24 z-50"><div class="wrapper px-4"><div class="py-32"><div class="flex flex-col gap-16 md:flex-row md:gap-8"><div class="relative w-full md:w-2/3"><h3 class="leading-[.9971em] tracking-[-0.01em] font-[yoga] text-3xl sm:text-5xl md:text-7xl
						lg:text-8xl font-bold w-full md:max-w-[400px] text-wrap">Design the ​future</h3> <div class="hidden md:block"><div class="absolute top-0 z-50 right-[70px] w-[20%] h-[100px] font-bold"><div class="animation_container w-full h-full"><div class="w-[250px] h-[100px] overflow-hidden relative"><!></div></div></div></div></div> <div class="w-2/3 md:w-1/3"><button class="font-[yoga]"><h3 class="text-md md:text-2xl font-bold rounded-full border-spacing-1 border-2
							border-white p-4 md:p-6 lg:py-8 lg:px-8 xl:py-8 xl:px-12">Work with us</h3></button></div></div> <!></div></div></section>`);function R(s,t){v(t,!1),m();var e=I(),c=a(e),i=a(c),o=a(i),r=a(o),u=a(r),g=l(l(u,!0)),w=a(g),h=a(w),k=a(h),C=a(k);E(C,{});var j=l(l(o,!0));V(j,{}),x(s,e),p()}var T=M(`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet" version="1.0" viewBox="0.0 0.0 1479.7 1479.7" zoomAndPan="magnify"><g id="change1_1"><path d="M1441.7275391,323.0449219c-26.0556641-64.2524414-64.3349609-121.8999023-113.7773438-171.3413086
